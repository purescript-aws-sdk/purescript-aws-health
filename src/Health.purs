...
describeAffectedEntities = Request.request service method  where
    service = Request.ServiceName "Health"
    method = Request.MethodName "describeAffectedEntities"
...
describeEntityAggregates = Request.request service method  where
    service = Request.ServiceName "Health"
    method = Request.MethodName "describeEntityAggregates"
...
describeEventAggregates = Request.request service method  where
    service = Request.ServiceName "Health"
    method = Request.MethodName "describeEventAggregates"
...
describeEventDetails = Request.request service method  where
    service = Request.ServiceName "Health"
    method = Request.MethodName "describeEventDetails"
...
describeEventTypes = Request.request service method  where
    service = Request.ServiceName "Health"
    method = Request.MethodName "describeEventTypes"
